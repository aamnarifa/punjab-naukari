    ...
    <div className='bg-white rounded-2xl shadow-lg p-6'>
      ...
      <div className='space-y-4'>
        {notifications.map((notification) => {
          ...
          return (
            <div key={notification.id} className='flex items-start p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200'>
              <div className={`${notification.color} text-white p-2 rounded-lg mr-4 flex-shrink-0`}>
