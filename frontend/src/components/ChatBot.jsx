...
const ChatBot = () => {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className={`fixed bottom-6 right-6 w-96 bg-white/95 backdrop-blur rounded-lg shadow-2xl border border-gray-200 z-50 transition-all duration-300 ${
          ...
          {!isMinimized && (
            <>
              <div className="flex-1 overflow-y-auto p-4 space-y-4 h-[350px] bg-gradient-to-b from-gray-50 to-white">
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-800">Welcome to Job Assistant</h4>
                          <p className="text-sm text-gray-600 mt-1">Ask me about jobs by role, location, experience, or qualification.</p>
                    ...
                    <div
                      className={`max-w-[80%] p-3 rounded-2xl shadow-sm transition-transform duration-200 ${
                        message.type === 'user'
                          ...
                          : 'bg-white text-gray-800 border border-gray-200 translate-y-0'
                      }`}
                    >
